...
const cards = [
  {
    ...
    description:
      "Explore the fundamentals and advanced concepts of AI, from machine learning algorithms to neural networks.",
  ...
  },
  {
    ...
    description:
      "Master the art of creating algorithms that learn from data, make predictions, and improve over time.",
  ...
  },
  {
    ...
    title: "Deep Learning",
    description:
      "Dive into the world of artificial neural networks and their applications in computer vision, natural language processing, and more.",
  ...
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-8 transition-colors duration-200">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-16 text-gray-900 dark:text-white">
          Super catchy AI Startup
        </h2>
        <div className="grid md:grid-cols-2 mt-20 gap-12 items-start">
  ...
  return (
    ...
    >
      ...
      <div className="flex-grow">
        <h3
          className={`font-semibold text-lg mb-2 text-gray-900 dark:text-white transition-opacity duration-200 ${
